...
Данный ATA драйвер был улучшен для поддержки мультизадачности в операционной системе Solar. Драйвер поддерживает как традиционный PIO режим, так и асинхронные операции для лучшей производительности в многопоточной среде.
